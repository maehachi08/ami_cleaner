...
## --dry-run option sample

```
$ python3 ami_cleaner/ami_cleaner.py --dry-run --days 0
+-----------------------+------------------------------------------------+--------------------------+
|        ImageId        |                      Name                      |       CreationDate       |
+-----------------------+------------------------------------------------+--------------------------+
| ami-062f56d65b681e393 | amzn-ami-2018.03.20200205-amazon-ecs-optimized | 2020-02-19T13:54:24.000Z |
+-----------------------+------------------------------------------------+--------------------------+
```
